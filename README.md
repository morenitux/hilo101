...
Formación de trenes y Manuales están temporalmente deshabilitados.

## Uso

Abre `index.html` en tu navegador. Conserva los archivos HTML y las carpetas `css`, `js` y `procedimientos` en la misma ubicación.
...
Los documentos se encuentran en `procedimientos/`, organizados en carpetas y subcarpetas. El listado se mantiene en `procedimientos.html`: cada fila contiene el enlace al PDF y el nombre del procedimiento. Algunos nombres están pendientes de completar.
